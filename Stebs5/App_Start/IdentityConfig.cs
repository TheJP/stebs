...
namespace Stebs5
{
    ...
    public class StebsUserManager : UserManager<StebsUser>
    {
        ...
        public static StebsUserManager Create(IdentityFactoryOptions<StebsUserManager> options, IOwinContext context)
        {
            ...
            //});
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<StebsUser>
            {
                Subject = "Stebs - Security Code",
            ...
            {
                manager.UserTokenProvider = new DataProtectorTokenProvider<StebsUser>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
